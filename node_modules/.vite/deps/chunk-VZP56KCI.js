...
var Session = class _Session {
  ...
  isScopeChanged(scopes) {
    ...
    const scopesObject = scopes instanceof AuthScopes ? scopes : new AuthScopes(scopes);
...
`);
  ...
  if ((_b2 = config.future) == null ? void 0 : _b2.v10_lineItemBilling) {
    logger2.deprecated("11.0.0", "v10_lineItemBilling will become enabled in v11. Use flag lineItemBilling instead");
  }
}
...
var DEFAULT_CLIENT_VERSION = "0.3.4";
...
var StorefrontClient = class {
  ...
  async query(params) {
    logger(this.storefrontClass().config).deprecated("11.0.0", "The query method is deprecated, and was replaced with the request method.\nSee the migration guide: https://github.com/Shopify/shopify-app-js/blob/main/packages/apps/shopify-api/docs/migrating-to-v9.md#using-the-new-clients.");
    if (typeof params.data === "string" && params.data.length === 0 || Object.entries(params.data).length === 0) {
      throw new MissingRequiredArgument("Query missing.");
    }
    let operation;
...
function nonce() {
  const length = 15;
  const bytes = cryptoVar.getRandomValues ? cryptoVar.getRandomValues(new Uint8Array(length)) : cryptoVar.randomBytes(length);
...
function subscriptions(config) {
  return async function({ session }) {
    ...
    return (_a2 = response.data) == null ? void 0 : _a2.currentAppInstallation;
  };
}
...
//# sourceMappingURL=chunk-VZP56KCI.js.map
